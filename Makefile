...
circles src/main.c:
	gcc $(CFLAGS) $(LDFLAGS) src/main.c -o bin/circles $(LDLIBS)
install: src/main.c 
	gcc $(CFLAGS) $(LDFLAGS) src/main.c -o bin/circles $(LDLIBS) && cp -f ./bin/circles $(HOME)/.local/bin/
web: src/main.c 
	emcc src/main.c -o bin/circles.html $(CWEB) -lm
